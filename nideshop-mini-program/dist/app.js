...
var store = dvaApp.getStore(); //  getStore是一个函数！！！要执行！！！
...
var _model3 = __webpack_require__(/*! ../pages/search/model */ "./src/pages/search/model.ts");
...
var Model = {
  ...
  effects: {
    // 获取首页数据
    fetchIndexData: /*#__PURE__*/_regenerator2.default.mark(function fetchIndexData(_ref, _ref2) {
      var payload = _ref.payload;
      var call = _ref2.call,
          put = _ref2.put;
      var response;
      return _regenerator2.default.wrap(function fetchIndexData$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return call(_service.getIndexData, payload);
    ...
    // 获取商品总数
    fetchGoodsCount: /*#__PURE__*/_regenerator2.default.mark(function fetchGoodsCount(_ref3, _ref4) {
      var call = _ref4.call,
          put = _ref4.put;
      var response;
      return _regenerator2.default.wrap(function fetchGoodsCount$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return call(_service.getGoodsCount);
...
exports.getGoodsCount = exports.getIndexData = undefined;
...
var getIndexData = exports.getIndexData = function getIndexData() {
  return (0, _request2.default)({
    url: '/home',
    method: 'GET'
  });
};
var getGoodsCount = exports.getGoodsCount = function getGoodsCount() {
  return (0, _request2.default)({
    url: '/goods/count',
    method: 'GET'
  });
...
var _service = __webpack_require__(/*! ./service */ "./src/pages/search/service.ts");
...
var Model = {
  ...
  effects: {
    // 获取搜索页面展示数据
    fetchSearchData: /*#__PURE__*/_regenerator2.default.mark(function fetchSearchData(_ref, _ref2) {
      var callback = _ref.callback;
      var call = _ref2.call,
          put = _ref2.put;
      var response;
      return _regenerator2.default.wrap(function fetchSearchData$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return call(_service.fetchSearchData);
      ...
      }, fetchSearchData, this);
    }),

    // 获取搜索提示数据
    fetchSearchHelperData: /*#__PURE__*/_regenerator2.default.mark(function fetchSearchHelperData(_ref3, _ref4) {
      var payload = _ref3.payload;
      var call = _ref4.call,
          put = _ref4.put;
      var response;
      return _regenerator2.default.wrap(function fetchSearchHelperData$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return call(_service.fetchSearchHelperData, payload);
      ...
      }, fetchSearchHelperData, this);
    }),

    // 获取商品列表
    fetchGoodsList: /*#__PURE__*/_regenerator2.default.mark(function fetchGoodsList(_ref5, _ref6) {
      var payload = _ref5.payload;
      var call = _ref6.call,
          put = _ref6.put;
      var response;
      return _regenerator2.default.wrap(function fetchGoodsList$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return call(_service.fetchGoodsList, payload);
...
exports.fetchGoodsList = exports.fetchSearchHelperData = exports.fetchSearchData = undefined;
...
var fetchSearchData = exports.fetchSearchData = function fetchSearchData() {
  return (0, _request2.default)({
    url: '/search/index',
    method: 'GET'
  });
};
var fetchSearchHelperData = exports.fetchSearchHelperData = function fetchSearchHelperData(params) {
  return (0, _request2.default)({
    url: '/search/helper',
    method: 'GET',
    data: params
...
var fetchGoodsList = exports.fetchGoodsList = function fetchGoodsList(params) {
  return (0, _request2.default)({
    url: '/goods/list',
    method: 'GET',
    data: params

...
var Index = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Index() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Index.__proto__ || Object.getPrototypeOf(Index)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "loopArray15", "loopArray16", "loopArray18", "$compid__6", "banner", "channel", "brandList", "newGoodsList", "hotGoodsList", "topicList", "categoryList"], _this.customComponents = ["AtSearchBar"], _temp), _possibleConstructorReturn(_this, _ret);
  }
  ...
  _createClass(Index, [{
    ...
    value: function _createData() {
      ...
      var loopArray15 = newGoodsList.map(function (item, _anonIdx7) {
        item = {
      ...
      var loopArray16 = hotGoodsList.map(function (item, _anonIdx9) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };
      ...
      var loopArray18 = categoryList.map(function (category, _anonIdx15) {
        category = {

...
function pitch() {
    const { sourceDir, fileType } = loader_utils_1.getOptions(this);
    ...
    if (query.type === 'template') {
        ...
        if (helper_1.NODE_MODULES_REG.test(this.resourcePath)) {
            const baseContext = path.join(process.cwd(), helper_1.NODE_MODULES);

...
_ref2) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    var selectorFactoryOptions = _objectSpread2(_objectSpread2({}, connectOptions), {}, {
    ...
    var Connect = /*#__PURE__*/function (_Component) {
      ...
      _proto.beforeRouteLeave = function beforeRouteLeave(from, to, next) {
        if (this.wrappedInstance && typeof this.wrappedInstance.beforeRouteLeave === 'function') {
          tryToCall.apply(void 0, [this.wrappedInstance.beforeRouteLeave, this.wrappedInstance].concat(Array.prototype.slice.call(arguments)));
        } else {
          next(true);
        }
      };
...
function defaultMergeProps(stateProps, dispatchProps, ownProps) {
  return _objectSpread2(_objectSpread2(_objectSpread2({}, ownProps), stateProps), dispatchProps);
}
